...
class EyeGestures{ // strip export default before making cdn/web embeddable version 
    ...
    onFaceMeshResults(results) {
        ...
        //Special right eye points are 33 [0], 133 [1], 145 [11], 159 [4]
        const RIGHT_EYE_KEYPOINTS = [
            33, 133, 160, 159, 158, 157, 173, 155, 154, 153, 144, 145, 153, 246, 468
        ];
        //Special left eye points are 362 [0], 374 [10], 263 [1], 386 [3]
    ...
    processKeyPoints(left_eye_coordinates,right_eye_coordinates,offset_x,offset_y,scale_x,scale_y,width,height)
    {
        ...
        //Additional stuff: blink ratios
        let rightEyeHorizontal1 = right_eye_coordinates[0];
        let rightEyeHorizontal2 = right_eye_coordinates[1];

        let rightEyeVertical1 = right_eye_coordinates[3];
        let rightEyeVertical2 = right_eye_coordinates[10];

        let leftEyeHorizontal1 = left_eye_coordinates[0];
        let leftEyeHorizontal2 = left_eye_coordinates[1];

        let leftEyeVertical1 = left_eye_coordinates[3];
        let leftEyeVertical2 = left_eye_coordinates[10];

        let rightRatio = euclideanDistance(rightEyeHorizontal1,rightEyeHorizontal2)/euclideanDistance(rightEyeVertical1,rightEyeVertical2);
        let leftRatio = euclideanDistance(leftEyeHorizontal1,leftEyeHorizontal2)/euclideanDistance(leftEyeVertical1,leftEyeVertical2);
        
        this.onGaze(point,calibration,[leftRatio,rightRatio]);
    }
